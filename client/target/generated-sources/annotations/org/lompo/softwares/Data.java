...
public final class Data implements Cloneable {
  ...
  public java.util.List<java.lang.String> getWords() {
    ...
    try {
      proto.acquireLock();
      return org.lompo.softwares.DataModel.words(arg1);
    } finally {
      proto.releaseLock();
    }
  }
  ...
  private static class Html4JavaType extends org.netbeans.html.json.spi.Proto.Type<Data> {
    ...
    @Override public void call(Data model, int type, Object data, Object ev) throws Exception {
      switch (type) {
        case 0:
          org.lompo.softwares.DataModel.turnAnimationOn(model);
          return;
        case 1:
          org.lompo.softwares.DataModel.turnAnimationOff(model);
          return;
        case 2:
          org.lompo.softwares.DataModel.rotate5s(model);
          return;
        case 3:
          org.lompo.softwares.DataModel.showScreenSize(model);
          return;
      }
      throw new UnsupportedOperationException();
    }
